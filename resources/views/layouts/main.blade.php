...
<head>
    ...
    <link rel="icon" href="https://docoh.com/files/LOGO/1001807-TLK.png" type="image/x-icon">
    ...
    <div id="wrapper">
        ...
        <ul class="nav navbar-nav bg-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/home">
                <div class="sidebar-brand-text mx-3">Meeting<sup>Booking</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#">Manage booking data</a>
                        <a class="collapse-item" href="#">Manage booking guest</a>
                    </div>
                </div>
            </li>
        </ul>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Booking Meeting 2022 </span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
